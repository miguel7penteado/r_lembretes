...
cat("\n+*************************************************************+")
cat("\n| Carregamento de relatorio com a função plot usando jitter   |")
cat("\n| e type                                                      |")
cat("\n+*************************************************************+")
cat("\n|                                                             |")
cat("\n+*************************************************************+")
...
plot(jitter(Orange$age),Orange$circumference, xlab="Idade",ylab="Circunferência",col="blue",main="Plantação:",pch=20,type="b")
